...
def extract_building_options(messages):
    ...
    for i in range(0, len(messages), batch_size):
        ...
        prompt = f"""
        Please extract the buildings selected by the client from the buildings which sales Rep sent from this chat.
        ...
        If no building is selected by client, return "Not Found".
...
def seleted_building(sales_rep, weeks):
